...
import lineupspro from "/assets/images/lineupspro.svg";
...
export const lineupsPro = lineupspro;
export const searchImg = search;
export const mailImg = mail;
export const burgerImg = burger;
export const burgerCloseImg = burgerclose;
...
export const mailTo = "mailto:no-reply@example.com";